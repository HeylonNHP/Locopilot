      ...
      <div className="skills-panel-body">
        ...
        {error && (
          <div className="skills-panel-error">
            ...
            <button className="skills-panel-error-retry" onClick={fetchSkills}>
              Retry
            </button>
          </div>
        )}
        {!loading && skills.length === 0 && (
          <div className="skills-panel-empty">
            ...
            <p className="skills-panel-empty-hint">
              ...
              <code className="skills-panel-empty-code">.locopilot/skills/&lt;name&gt;/</code> with
              a <code className="skills-panel-empty-code">SKILL.md</code> file.
            </p>
          </div>
        )}
        {skills.map((skill) => (
            ...
            <div className="skills-panel-skill-row">
              <div className="skills-panel-skill-info">
                ...
                <div className="skills-panel-skill-badges">
                  ...
                  {skill.autoInvoke && (
                    <span className="skills-panel-badge skills-panel-badge--auto">auto-invoke</span>
                  )}
                </div>
              </div>
              <label
